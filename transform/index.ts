...
const data: {
    ...
    nativeIterfaceVaraible?: ts.Identifier
...
export default Hook({
    initialize: ({
        ...
        data.nativeIterfaceVaraible = ts.createUniqueName('interface')
        data.interfaceVaraible = ts.createPropertyAccess(
            data.nativeIterfaceVaraible,
            ts.createIdentifier('eng')
        )
